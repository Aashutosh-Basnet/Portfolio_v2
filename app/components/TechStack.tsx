...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className="py-20 px-6 bg-white text-black">
      <style>
        {`
          .sphere-container {
            position: relative;
      ...
      <div className="container mx-auto">
        <RevealWrapper className="text-center mb-16" direction="up" delay={0.1}>
        ...
        >
          <div
            className="sphere-container h-full w-full flex items-center justify-center" // Wrapper div to handle refs correctly if needed, but RevealWrapper passes ref to its div
            ref={containerRef}
          ...
          >
            ...
            >
              {technologies.map((tech, i) => (
                ...
                >
                  <div className="w-16 h-16 flex items-center justify-center rounded-full bg-white shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-2px_rgba(0,0,0,0.1)] group-hover:scale-110 transition-transform duration-300 border border-gray-100">
                    {tech.icon}
                  </div>
                  <p className="absolute top-full left-1/2 -translate-x-1/2 mt-2 px-2 py-1 text-sm bg-gray-100 text-black rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap border border-gray-200 shadow-sm">
                    {tech.name}
                  </p>
                </div>
              ))}
        ...
        <RevealWrapper className="mt-12 flex justify-end" direction="up" delay={0.5}>
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <Link href="/project">
              <span className="bg-white hover:bg-gray-50 text-black rounded-xl text-md flex gap-2 items-center px-6 py-3 shadow-md border border-gray-200 transition-all duration-300">
            ...
            <button
              ...
              className="bg-white hover:bg-gray-50 text-black rounded-xl text-md flex gap-2 items-center px-6 py-3 shadow-md border border-gray-200 transition-all duration-300"
            >
              <UserCircle2 size={20} />
              About Me
            </button>
